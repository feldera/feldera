...
[`GET /v0/tenant/users`](/api/list-tenant-members), the web console's member
...
Feldera reads the name and email from the provider's
[OIDC UserInfo endpoint](https://openid.net/specs/openid-connect-core-1_0.html#UserInfo),
because an access token often carries neither.
