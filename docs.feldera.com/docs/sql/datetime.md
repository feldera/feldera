...
| <a id="date_timestampdiff"></a>`TIMESTAMPDIFF(*unit*, left, right)` | `DATE` | `INTEGER` | Computes the difference (right - left) between two dates values and expresses the result in the specified time units. | `TIMESTAMPDIFF(HOUR, '2020-01-01', '2020-02-01')` => `24` |
