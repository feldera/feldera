...
* `*`: [operators](operators.md#muldiv)
* `+`: [operators](operators.md#plusminus), [datetime](datetime.md#other-datetimetimestamptime-interval-operations)
* `-`: [operators](operators.md#plusminus), [datetime](datetime.md#date-operations)
* `.`: [grammar](grammar.md#as)
* `/`: [operators](operators.md#muldiv)
* `::`: [casts](casts.md#coloncolon)
* `<`: [comparisons](comparisons.md#lt)
* `<=`: [comparisons](comparisons.md#lte)
* `<=>`: [operators](operators.md#comparisons), [comparisons](comparisons.md#nne)
...
* `ARRAY_FLATTEN`: [array](array.md#array_flatten)
...
* `BROUND`: [decimal](decimal.md#bround)
...
* `COVAR_POP` (aggregate): [aggregates](aggregates.md#covar_pop)
* `COVAR_SAMP` (aggregate): [aggregates](aggregates.md#covar_samp)
...
* `FIRST_VALUE` (aggregate): [aggregates](aggregates.md#first_value)
...
* `GROUPING`: [grammar](grammar.md#grouping-functions)
* `GROUPING SETS`: [grammar](grammar.md#grouping-functions)
* `GROUPING_ID`: [grammar](grammar.md#grouping-functions)
...
* `LAST_VALUE` (aggregate): [aggregates](aggregates.md#last_value)
...
* `MAKE_DATE`: [datetime](datetime.md#make_date)
* `MAKE_TIME`: [datetime](datetime.md#make_time)
...
* `PIVOT`: [aggregates](aggregates.md#pivots)
* `POSITION`: [string](string.md#position), [binary](binary.md#position)
...
* `REGR_COUNT` (aggregate): [aggregates](aggregates.md#regr_count)
* `REGR_SXX` (aggregate): [aggregates](aggregates.md#regr_sxx)
* `REGR_SYY` (aggregate): [aggregates](aggregates.md#regr_syy)
* `REPEAT`: [string](string.md#repeat)
* `REPLACE`: [string](string.md#replace)
* `RESPECT NULLS`: [grammar](grammar.md#window-aggregates)
* `REVERSE`: [string](string.md#reverse)
* `RIGHT`: [string](string.md#right), [binary](binary.md#right)
* `RLIKE`: [string](string.md#rlike), [string](string.md#rlike-function)
...
* `SUBSTRING`: [string](string.md#substring), [binary](binary.md#substring)
* `SUCCEEDS`: [datetime](datetime.md#succeeds)
* `SUM` (aggregate): [aggregates](aggregates.md#sum), [aggregates](aggregates.md#window-sum)
* `TABLE`: [table](table.md#syntax), [grammar](grammar.md#table-functions)
...
* `VARIANTNULL`: [json](json.md#functions-that-operate-on-variant-values)
* `WEEK`: [datetime](datetime.md#week)
* `XXHASH`: [string](string.md#xxhash), [binary](binary.md#xxhash)
* `YEAR`: [datetime](datetime.md#year)
* `||`: [string](string.md#concat-operator), [binary](binary.md#concat)
