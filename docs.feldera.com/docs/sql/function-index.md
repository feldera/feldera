...
* `LN`: [decimal](decimal.md#ln), [float](float.md#ln)
* `LOG`: [float](float.md#log)
* `LOG10`: [decimal](decimal.md#log10), [float](float.md#log10)
...
* `POWER`: [decimal](decimal.md#power), [float](float.md#power)
...
* `SQRT`: [decimal](decimal.md#sqrt), [float](float.md#sqrt)
