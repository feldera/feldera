...
| `ssl_ca_pem`            | string  |           | The CA certificate in PEM format. Required for TLS, and takes precedence over `ssl_ca_location`.                                                                                                                                                                                                |
| `ssl_ca_location`       | string  |           | The path to the CA certificate file in PEM format. Required for TLS, takes lower precedence than `ssl_ca_pem`.                                                                                                                                                                                                |
