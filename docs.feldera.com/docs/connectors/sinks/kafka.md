...
| `initialization_timeout` | duration | `60s` | Maximum time to wait for the connector to connect to a Kafka broker, for example `60s`. Replaces the deprecated `initialization_timeout_secs` (integer seconds). |
