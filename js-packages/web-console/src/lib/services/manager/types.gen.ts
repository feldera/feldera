...
export type DeltaTableReaderConfig = {
   ...
   */
  '[key: string]':
    | (string | number | DeltaTableIngestMode | boolean | DeltaTableTransactionMode)
    | undefined
}
...
export type GetPipelineCircuitJsonProfileError = ErrorResponse
...
export type GetPipelineDataflowGraphError = ErrorResponse
...
export type $OpenApiTs = {
  ...
  '/v0/pipelines/{pipeline_name}/circuit_json_profile': {
    get: {
      req: GetPipelineCircuitJsonProfileData
      res: {
        /**
  ...
  '/v0/pipelines/{pipeline_name}/dataflow_graph': {
    get: {
      req: GetPipelineDataflowGraphData
      res: {
        /**
