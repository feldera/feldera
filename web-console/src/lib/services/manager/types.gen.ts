 ...
 * ```
 */
export type StorageStatus = 'Unbound' | 'Bound' | 'Unbinding'
...
export type PostPipelineUnbindData = {
  path: {
    /**
     * Unique pipeline name
     */
...
export type PostPipelineUnbindResponse = unknown

export type PostPipelineUnbindError = ErrorResponse
...
export type $OpenApiTs = {
  ...
  '/v0/pipelines/{pipeline_name}/unbind': {
    post: {
      req: PostPipelineUnbindData
      res: {
        /**
         * Action is accepted and is being performed
         */
