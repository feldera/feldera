...
<div
  class="bg-white-dark sticky -top-4 z-10 -m-4 mb-0 flex flex-nowrap justify-between p-4 pb-2 md:-top-6 md:-m-6 md:mb-0 md:p-6 md:pb-2"
>
        ...
        {#snippet title()}
          <span class="text-lg"
            >{numRelationsToRemove === 1
              ...
              : `${numRelationsToRemove} Deleted Tables and Views`}</span
          >
        {/snippet}
        ...
        {#snippet title()}
          <span class="text-lg"
            >{numTablesToBackfill === 1
              ...
              : `${numTablesToBackfill} Tables to Be Reinitialized`}</span
          >
        {/snippet}
        {@render dropdownHeader(open, toggle, title)}
      {/snippet}
        ...
        {#snippet title()}
          <span class="text-lg"
            >{numViewsToRecompute === 1
              ...
              : `${numViewsToRecompute} Views to Be Recomputed`}</span
          >
        {/snippet}
        {@render dropdownHeader(open, toggle, title)}
      {/snippet}
  ...
  <div>
    <InlineDropdown bind:open={showConnectorsDeleted}>
        ...
        {#snippet title()}
          <span class="text-lg"
            >{numConnectorsToRemove === 1
              ...
              : `${numConnectorsToRemove} Deleted Connectors`}</span
          >
        {/snippet}
        {@render dropdownHeader(open, toggle, title)}
      {/snippet}
      {#snippet content()}
        <div transition:slide={{ duration: 150 }}>
          <div class="pb-4 text-surface-500">
            These connectors have been deleted and will no longer be available
          </div>
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-12">
  ...
  <div>
    <InlineDropdown bind:open={showConnectorsToReinitialize}>
        ...
        {#snippet title()}
          <span class="text-lg"
            >{numConnectorsToBackfill === 1
              ...
              : `${numConnectorsToBackfill} Input Connectors to Be Reinitialized`}</span
          >
        {/snippet}
        {@render dropdownHeader(open, toggle, title)}
      {/snippet}
      {#snippet content()}
        <div transition:slide={{ duration: 150 }}>
          <div class="pb-4 text-surface-500">
            These input connectors will restart and backfill data from the beginning
          </div>
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-12">
  ...
  <div>
    <InlineDropdown bind:open={showConnectorsToRecompute}>
        ...
        {#snippet title()}
          <span class="text-lg"
            >{numConnectorsToRecompute === 1
              ...
              : `${numConnectorsToRecompute} Output Connectors to Be Recomputed`}</span
          >
        {/snippet}
        {@render dropdownHeader(open, toggle, title)}
      {/snippet}
      {#snippet content()}
        <div transition:slide={{ duration: 150 }}>
          <div class="pb-4 text-surface-500">
            These output connectors will receive fully recomputed data streams
          </div>
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-12">
