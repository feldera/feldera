...
class Pipeline:
    ...
    def wait_for_status(
        ...
        while True:
            ...
            if time.monotonic() - start_time >= timeout_s:
                raise TimeoutError(
                    f"Pipeline did not reach {expected_status.name} status within {timeout_s} seconds"
                )
    ...
    def wait_for_idle(
        ...
        poll_interval_s: float = WAIT_POLL_INTERVAL_IDLE_DEFAULT_S,
    ):
        """
