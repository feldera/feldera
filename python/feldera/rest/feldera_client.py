...
{resp.deployment_error.get("message", "")}"""
    ...
    def input_connector_stats(self, pipeline_name: str, table_name: str, connector_name: str) -> dict:
        """
        Get the status of the specified input connector.
        """
        return self.http.get(path=f"/pipelines/{pipeline_name}/tables/{table_name}/connectors/{connector_name}/stats")

    def output_connector_stats(self, pipeline_name: str, view_name: str, connector_name: str) -> dict:
        """
        Get the status of the specified output connector.
        """
        return self.http.get(path=f"/pipelines/{pipeline_name}/views/{view_name}/connectors/{connector_name}/stats")
