...
CREATE OR REPLACE TEMP VIEW sensor_value_extract AS SELECT sensor_id, get_json_object(reading_json, '$.temperature') AS temp_value FROM sensor_readings WHERE sensor_id > 0;
