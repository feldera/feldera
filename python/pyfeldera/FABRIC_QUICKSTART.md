...
print("🔗 Starting Privy relay proxy...")
RelayServer(
    namespace=RELAY_NS, path=RELAY_PATH, keyrule=RELAY_RULE, key=RELAY_KEY,
...
ProxyClientServer(
    namespace="mdrrahman-dev-relay", path="demo",
