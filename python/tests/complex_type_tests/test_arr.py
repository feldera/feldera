...
class cmpxtst_array_int_var_tbl(TstTable):
    ...
    def __init__(self):
        ...
        self.data = [
            {"id": 0, "c1_arr": [1, 2, None], "c2_arr": [4, 5, 6], "c3_arr": ["Ciao", None],  "c4_arr": ["Hello", "Hi"]},
            {"id": 1, "c1_arr": [None], "c2_arr": [7, 8, 9], "c3_arr": [None], "c4_arr": ["Bye"]}
        ]
...
class cmpxtst_arr_field_access(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1_val1': 1, 'c1_val3': None, 'c2_val1': 4, 'c2_val2': 5, 'c3_val1': 'Ciao', 'c3_val2': 'Hi'},
            {'id': 1, 'c1_val1': None, 'c1_val3': None, 'c2_val1': 7, 'c2_val2': 8, 'c3_val1': None, 'c3_val2': None}
        ]
