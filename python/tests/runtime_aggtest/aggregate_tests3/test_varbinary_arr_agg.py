...
class aggtst_varbinary_array_agg_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "c1": [bytes.fromhex("0c1620"), bytes.fromhex("17382115"), bytes.fromhex("17382115"), bytes.fromhex("312b541d0b")],
                "c2": [None, bytes.fromhex("37424d58"), bytes.fromhex("63141f4d"), bytes.fromhex("2022")],
            }
        ]
...
class aggtst_varbinary_array_agg_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {"id": 1, "c1": [bytes.fromhex("17382115"), bytes.fromhex("312b541d0b")], "c2": [bytes.fromhex("63141f4d"), bytes.fromhex("2022")]},
        ]
...
class aggtst_varbinary_array_agg_distinct(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "c1": [bytes.fromhex("0c1620"), bytes.fromhex("17382115"), bytes.fromhex("312b541d0b")],
                "c2": [None, bytes.fromhex("2022"), bytes.fromhex("37424d58"), bytes.fromhex("63141f4d")],
            }
        ]
...
class aggtst_varbinary_array_agg_distinct_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            {"id": 0, "c1": [bytes.fromhex("0c1620"), bytes.fromhex("17382115")], "c2": [None, bytes.fromhex("37424d58")]},
            {"id": 1, "c1": [bytes.fromhex("17382115"), bytes.fromhex("312b541d0b")], "c2": [bytes.fromhex("2022"), bytes.fromhex("63141f4d")]},
        ]
