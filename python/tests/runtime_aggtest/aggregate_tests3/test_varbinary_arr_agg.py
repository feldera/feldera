...
class aggtst_varbinary_array_agg_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {
                "id": 1,
                "c1": [bytes.fromhex("17382115"), bytes.fromhex("312b541d0b")],
                "c2": [bytes.fromhex("63141f4d"), bytes.fromhex("2022")],
            },
        ]
    ...
    def __init__(self):
        ...
        self.data = [
            ...
            },
            {
                "id": 1,
                "c1": [bytes.fromhex("17382115"), bytes.fromhex("312b541d0b")],
                "c2": [bytes.fromhex("2022"), bytes.fromhex("63141f4d")],
            },
        ]
