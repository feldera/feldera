...
class aggtst_time_max_value(TstView):
    def __init__(self):
        ...
        self.data = [{"c1": datetime.time(14, 0, 0), "c2": datetime.time(18, 0, 0)}]
...
class aggtst_time_max_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {"id": 0, "c1": datetime.time(14, 0, 0), "c2": datetime.time(12, 45, 0)},
            {"id": 1, "c1": datetime.time(14, 0, 0), "c2": datetime.time(18, 0, 0)},
        ]
...
class aggtst_time_max_where(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{"f_c1": datetime.time(14, 0, 0), "f_c2": datetime.time(18, 0, 0)}]
...
class aggtst_time_max_where_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {"id": 1, "f_c1": datetime.time(14, 0, 0), "f_c2": datetime.time(18, 0, 0)},
        ]
