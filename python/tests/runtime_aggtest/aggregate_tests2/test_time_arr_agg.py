        ...
        self.data = [
            {
                ...
                "c2": [
                    datetime.time(12, 45, 0),
                    datetime.time(16, 30, 0),
                    None,
...
class aggtst_time_array_agg_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "id": 0,
                "c1": [datetime.time(8, 30, 0), datetime.time(14, 0, 0)],
                "c2": [datetime.time(12, 45, 0), None],
            },
            {
                "id": 1,
                "c1": [datetime.time(9, 15, 0), datetime.time(14, 0, 0)],
                "c2": [datetime.time(16, 30, 0), datetime.time(18, 0, 0)],
            },
        ]
