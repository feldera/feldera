...
class aggtst_interval_min_seconds_tz(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = aggtst_interval_min_seconds().data
        self.sql = """CREATE MATERIALIZED VIEW interval_min_seconds_tz AS SELECT
...
class aggtst_interval_min_gby_seconds_tz(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = aggtst_interval_min_gby_seconds().data
        self.sql = """CREATE MATERIALIZED VIEW interval_min_gby_seconds_tz AS SELECT
                      id,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c1) AS m_c1,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c2) AS m_c2,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c3) AS m_c3,
...
class aggtst_interval_min_distinct_seconds_tz(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = aggtst_interval_min_distinct_seconds().data
        self.sql = """CREATE MATERIALIZED VIEW interval_min_distinct_seconds_tz AS SELECT
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c1) AS m_c1,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c2) AS m_c2,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c3) AS m_c3,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c4) AS m_c4,
...
class aggtst_interval_min_distinct_gby_seconds_tz(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = aggtst_interval_min_distinct_gby_seconds().data
        self.sql = """CREATE MATERIALIZED VIEW interval_min_distinct_gby_seconds_tz AS SELECT
                      id,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c1) AS m_c1,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c2) AS m_c2,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c3) AS m_c3,
...
class aggtst_interval_min_where_seconds_tz(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = aggtst_interval_min_where_seconds().data
        self.sql = """CREATE MATERIALIZED VIEW interval_min_where_seconds_tz AS SELECT
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c1) AS m_c1,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c2) AS m_c2,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c3) AS m_c3,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c4) AS m_c4,
...
class aggtst_interval_min_where_gby_seconds_tz(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = aggtst_interval_min_where_gby_seconds().data
        self.sql = """CREATE MATERIALIZED VIEW interval_min_where_gby_seconds_tz AS SELECT
                      id,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c1) AS m_c1,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c2) AS m_c2,
                      TIMESTAMPDIFF(SECOND, d_tz(), d_tz() + f_c3) AS m_c3,
