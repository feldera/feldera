...
class aggtst_timestamp_min_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "c1": datetime.datetime(2014, 11, 5, 8, 27, 0),
                "c2": datetime.datetime(2014, 11, 5, 16, 30, 0),
            }
        ]
...
class aggtst_timestamp_min1_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "c1": datetime.datetime(1969, 3, 17, 11, 32, 0),
                "c2": datetime.datetime(2014, 11, 5, 16, 30, 0),
            }
        ]
        ...
        self.data = [
            {
                "id": 0,
                "c1": datetime.datetime(2014, 11, 5, 8, 27, 0),
                "c2": datetime.datetime(2024, 12, 5, 12, 45, 0),
            },
            {
                "id": 1,
                "c1": datetime.datetime(2020, 6, 21, 14, 0, 0),
                "c2": datetime.datetime(2014, 11, 5, 16, 30, 0),
            },
        ]
        ...
        self.data = [
            {
                ...
                "f_c2": datetime.datetime(2014, 11, 5, 16, 30, 0),
            }
        ]
...
class aggtst_timestamp_min_where1_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "id": 0,
                "f_c1": datetime.datetime(2014, 11, 5, 8, 27, 0),
                "f_c2": datetime.datetime(2024, 12, 5, 12, 45, 0),
            },
            {
                "id": 1,
                "f_c1": datetime.datetime(1969, 3, 17, 11, 32, 0),
                "f_c2": datetime.datetime(2015, 9, 7, 18, 57, 0),
            },
        ]
