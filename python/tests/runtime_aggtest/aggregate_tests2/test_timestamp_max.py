...
class aggtst_timestamp_max_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "c1": datetime.datetime(2024, 12, 5, 9, 15, 0),
    ...
    def __init__(self):
        ...
        self.data = [
            ...
            },
            {
                "id": 1,
                "c1": datetime.datetime(2024, 12, 5, 9, 15, 0),
                "c2": datetime.datetime(2023, 2, 26, 18, 0, 0),
            },
        ]
...
class aggtst_timestamp_max_where(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                "f_c1": datetime.datetime(2024, 12, 5, 9, 15, 0),
                "f_c2": datetime.datetime(2023, 2, 26, 18, 0, 0),
            }
        ]
