...
class aggtst_date_min_value(TstView):
    def __init__(self):
        ...
        self.data = [{"c1": datetime.date(1969, 3, 17), "c2": datetime.date(2014, 11, 5)}]
...
class aggtst_date_min_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {"id": 1, "c1": datetime.date(1969, 3, 17), "c2": datetime.date(2014, 11, 5)},
        ]
...
class aggtst_date_min_where(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{"f_c1": datetime.date(2020, 6, 21), "f_c2": datetime.date(2014, 11, 5)}]
...
class aggtst_date_min_where_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {"id": 1, "f_c1": datetime.date(2020, 6, 21), "f_c2": datetime.date(2014, 11, 5)},
        ]
