...
def single_tenant_auth(idp: Issuer, workload_idp: Issuer | None = None) -> AuthConfig:
...
def multi_tenant_auth(idp: Issuer, workload_idp: Issuer | None = None) -> AuthConfig:
    ...
    """
    config = single_tenant_auth(idp, workload_idp)
