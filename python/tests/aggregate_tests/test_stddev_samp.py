...
class test_int_stddev(TestView):
    def __init__(self):
...
class test_int_stddev_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_stddev_distinct(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_stddev_distinct_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_stddev_where(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'c1': 1, 'c2': 1, 'c3': None, 'c4': 1, 'c5': 2, 'c6': 2, 'c7': None, 'c8': 4}]
