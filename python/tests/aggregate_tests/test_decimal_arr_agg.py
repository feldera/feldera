...
class aggtst_decimal_array_agg_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': [None, Decimal('1111.52'), Decimal('5681.08'), Decimal('5681.08')],
                'c2': [Decimal('3802.71'), Decimal('2231.90'), Decimal('7335.88'), Decimal('7689.88')]
            }
        ]
...
class aggtst_decimal_array_agg_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1': [None, Decimal('1111.52')], 'c2': [Decimal('3802.71'), Decimal('2231.90')]},
            {'id': 1, 'c1': [Decimal('5681.08'), Decimal('5681.08')], 'c2': [Decimal('7335.88'), Decimal('7689.88')]}
        ]
        ...
        self.data = [
            {
                ...
                'c2': [Decimal('2231.90'), Decimal('3802.71'), Decimal('7335.88'), Decimal('7689.88')]
            }
        ]
...
class aggtst_decimal_array_agg_distinct_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1': [None, Decimal('1111.52')], 'c2': [Decimal('2231.90'), Decimal('3802.71')]},
            {'id': 1, 'c1': [Decimal('5681.08')], 'c2': [Decimal('7335.88'), Decimal('7689.88')]}
        ]
