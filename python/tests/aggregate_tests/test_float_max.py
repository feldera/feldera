...
class aggtst_real_max_value(TstView):
    def __init__(self):
        ...
        self.data = [{"c1": "57681.179688", "c2": "873315.8125"}]
...
class aggtst_real_max_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {"id": 0, "c1": "57681.179688", "c2": "2231.791016"},
            {"id": 1, "c1": "57681.179688", "c2": "873315.8125"},
        ]
...
class aggtst_real_max_where(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{"f_c1": "57681.179688", "f_c2": "-38.271118"}]
...
class aggtst_time_max_where_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {"id": 0, "f_c1": "57681.179688", "f_c2": "-38.271118"},
