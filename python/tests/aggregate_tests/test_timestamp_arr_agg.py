...
class aggtst_timestamp_array_agg_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': ['2014-11-05T08:27:00', '2020-06-21T14:00:00', '2020-06-21T14:00:00', '2024-12-05T09:15:00'], 
                'c2': ['2024-12-05T12:45:00', None, '2023-02-26T18:00:00', '2014-11-05T16:30:00']
            }
        ]
...
class aggtst_timestamp_array_agg_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1': ['2014-11-05T08:27:00', '2020-06-21T14:00:00'], 'c2': ['2024-12-05T12:45:00', None]},
            {'id': 1, 'c1': ['2020-06-21T14:00:00', '2024-12-05T09:15:00'], 'c2': ['2023-02-26T18:00:00', '2014-11-05T16:30:00']}
        ]
...
class aggtst_timestamp_array_agg_distinct(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': ['2014-11-05T08:27:00', '2020-06-21T14:00:00', '2024-12-05T09:15:00'], 
                'c2': [None, '2014-11-05T16:30:00', '2023-02-26T18:00:00', '2024-12-05T12:45:00']
            }
        ]
...
class aggtst_timestamp_array_agg_distinct_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1': ['2014-11-05T08:27:00', '2020-06-21T14:00:00'], 'c2': [None, '2024-12-05T12:45:00']},
            {'id': 1, 'c1': ['2020-06-21T14:00:00', '2024-12-05T09:15:00'], 'c2': ['2014-11-05T16:30:00', '2023-02-26T18:00:00']}
        ]
...
class aggtst_timestamp_array_agg_where(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'f_c1': ['2020-06-21T14:00:00', '2020-06-21T14:00:00', '2024-12-05T09:15:00'],
...
class aggtst_timestamp_array_agg_where_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {'id': 1, 'f_c1': ['2020-06-21T14:00:00', '2024-12-05T09:15:00'], 'f_c2': ['2023-02-26T18:00:00', '2014-11-05T16:30:00']}
        ]
