...
class aggtst_row_array_agg_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': [{'expr$0': None, 'expr$1': 'adios'}, {'expr$0': 'elo', 'expr$1': 'ciao'},
                       {'expr$0': 'elo', 'expr$1': 'ciao'}, {'expr$0': 'hi', 'expr$1': 'hiya'},
...
class aggtst_row_array_agg_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1': [{'expr$0': None, 'expr$1': 'adios'}, {'expr$0': 'ola', 'expr$1': 'ciao'}], 'c2': [4, 3]},
            {'id': 1, 'c1': [{'expr$0': 'elo', 'expr$1': 'ciao'}, {'expr$0': 'elo', 'expr$1': 'ciao'},
                             {'expr$0': 'hi', 'expr$1': 'hiya'}], 'c2': [2, 2, 7]}
        ]
...
class aggtst_row_array_agg_distinct(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': [{'expr$0': None, 'expr$1': 'adios'}, {'expr$0': 'elo', 'expr$1': 'ciao'},
                       {'expr$0': 'hi', 'expr$1': 'hiya'}, {'expr$0': 'ola', 'expr$1': 'ciao'}],
                'c2': [2, 3, 4, 7]
            }
        ]
...
class aggtst_row_array_agg_distinct_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'c1': [{'expr$0': None, 'expr$1': 'adios'}, {'expr$0': 'ola', 'expr$1': 'ciao'}], 'c2': [3, 4]},
            {'id': 1, 'c1': [{'expr$0': 'elo', 'expr$1': 'ciao'}, {'expr$0': 'hi', 'expr$1': 'hiya'}], 'c2': [2, 7]}
        ]
