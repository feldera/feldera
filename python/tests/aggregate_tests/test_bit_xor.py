...
class test_int_bit_xor(TestView):
    def __init__(self):
...
class test_int_bit_xor_Groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_bit_xor_distinct(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_bit_xor_distinct_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_bit_xor_where(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_bit_xor_where_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
