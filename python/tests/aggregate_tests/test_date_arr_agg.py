...
class aggtst_date_array_agg_value(TstView):
    def __init__(self):
        ...
        self.data = [{'c1': ['1969-03-17', '2014-11-05', '2020-06-21', '2020-06-21', '2024-12-05'], 'c2': ['2015-09-07', '2024-12-05', None, '2023-02-26', '2014-11-05']}]
...
class aggtst_date_array_agg_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {'id': 1, 'c1': ['1969-03-17', '2020-06-21', '2024-12-05'], 'c2': ['2015-09-07', '2023-02-26', '2014-11-05']}
        ]
...
class aggtst_date_array_agg_distinct(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'c1': ['1969-03-17', '2014-11-05', '2020-06-21', '2024-12-05'], 'c2': [None, '2014-11-05', '2015-09-07', '2023-02-26', '2024-12-05']}]
...
class aggtst_date_array_agg_distinct_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {'id': 1, 'c1': ['1969-03-17', '2020-06-21', '2024-12-05'], 'c2': ['2014-11-05', '2015-09-07', '2023-02-26']}
        ]
...
class aggtst_date_array_agg_where(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'f_c1': ['2020-06-21', '2020-06-21', '2024-12-05'], 'f_c2': ['2015-09-07', '2024-12-05', '2023-02-26']}]
...
class aggtst_date_array_agg_where_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {'id': 1, 'f_c1': ['2020-06-21', '2024-12-05'], 'f_c2': ['2015-09-07', '2023-02-26']}
        ]
