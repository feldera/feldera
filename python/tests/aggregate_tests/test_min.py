...
class test_int_min_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_min_distinct(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'c1': 4, 'c2': 2, 'c3': 3, 'c4': 2, 'c5': 2, 'c6': 1, 'c7': 3, 'c8': 2}]
...
class test_int_min_distinct_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'id': 0, 'c1': 5, 'c2': 2, 'c3': 3, 'c4': 2, 'c5': 3, 'c6': 4, 'c7': 3, 'c8': 3},
                     {'id': 1, 'c1': 4, 'c2': 3, 'c3': 4, 'c4': 2, 'c5': 2, 'c6': 1, 'c7': 4, 'c8': 2}]
...
class test_int_min_where(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_min_where_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
