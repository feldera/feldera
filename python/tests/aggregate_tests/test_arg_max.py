...
class aggtst_int_arg_max_diff(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'c1': None, 'c2': 2, 'c3': 4, 'c4': 2, 'c5': 5, 'c6': 6, 'c7': None, 'c8': 2}]
...
class aggtst_int_arg_max_gby_diff(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'id': 0, 'c1': 5, 'c2': 2, 'c3': None, 'c4': 2, 'c5': 5, 'c6': 6, 'c7': None, 'c8': 3},
                     {'id': 1, 'c1': None, 'c2': 3, 'c3': 4, 'c4': 2, 'c5': 2, 'c6': 3, 'c7': None, 'c8': 2}]
...
class aggtst_int_arg_max_where(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'f_c1': 5, 'f_c2': 5, 'f_c3': 6, 'f_c4': 4, 'f_c5': 5, 'f_c6': 6, 'f_c7': 3, 'f_c8': 8}]
...
class aggtst_int_arg_max_where_diff(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'f_c1': None, 'f_c2': 2, 'f_c3': None, 'f_c4': 2, 'f_c5': 5, 'f_c6': 6, 'f_c7': None, 'f_c8': 3}]
...
class aggtst_int_arg_max_where_diff_gby(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'id': 0, 'f_c1': 5, 'f_c2': 2, 'f_c3': None, 'f_c4': 2, 'f_c5': 5, 'f_c6': 6, 'f_c7': None, 'f_c8': 3},
                     {'id': 1, 'f_c1': None, 'f_c2': 5, 'f_c3': 6, 'f_c4': 2, 'f_c5': 2, 'f_c6': 1, 'f_c7': None, 'f_c8': 5}]
