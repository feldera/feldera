...
class aggtst_interval_max_seconds(TstView):
    def __init__(self):
        ...
        self.data = [{'m_c1': 1592695620, 'm_c2': 1466619540, 'm_c3': 229712400, 'm_c4': 571691580, 'm_c5': 894927960, 'm_c6': 1681851120}]
...
class aggtst_interval_max_gby_seconds(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {'id': 0, 'm_c1': 1592695620, 'm_c2': 318226680, 'm_c3': -89155500, 'm_c4': 169024440, 'm_c5': 149202240, 'm_c6': 1681851120},
            {'id': 1, 'm_c1': 1592695620, 'm_c2': 1466619540, 'm_c3': 229712400, 'm_c4': 571691580, 'm_c5': 894927960, 'm_c6': 1635868800}
        ]
...
class aggtst_interval_max_where_seconds(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'m_c1': 1592695620, 'm_c2': -318185100, 'm_c3': 229712400, 'm_c4': -229712400, 'm_c5': 894927960, 'm_c6': -149202240}]
...
class aggtst_interval_max_where_gby_seconds(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {'id': 1, 'm_c1': 1592695620, 'm_c2': -318185100, 'm_c3': 229712400, 'm_c4': -229712400, 'm_c5': 894927960, 'm_c6': -894927960}
        ]
