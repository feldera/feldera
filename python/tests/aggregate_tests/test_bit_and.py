...
class test_int_bit_and(TestView):
    def __init__(self):
...
class test_int_bit_and_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_bit_and_distinct(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'c1': 4, 'c2': 0, 'c3': 0, 'c4': 0, 'c5': 0, 'c6': 0, 'c7': 0, 'c8': 0}]
...
class test_int_bit_and_distinct_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'id': 0, 'c1': 5, 'c2': 2, 'c3': 3, 'c4': 0, 'c5': 1, 'c6': 4, 'c7': 3, 'c8': 0},
                     {'id': 1, 'c1': 4, 'c2': 1, 'c3': 4, 'c4': 2, 'c5': 2, 'c6': 1, 'c7': 4, 'c8': 0}]
...
class test_int_bit_and_where(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_bit_and_where_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
