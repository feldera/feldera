...
class aggtst_array_arr_agg_gby(TstView):
    def __init__(self):
        # checked manually
        self.data = [
            {"id": 0, "c1": [[12, 22], [23, 56, 16]], "c2": [None, [55, 66, None]], 'c3': [[{'a': 5, 'b': 66}], [{'c': 2}]]},
            {"id": 1, "c1": [[23, 56, 16], [49]], "c2": [[99], [32, 34, 22, 12]], 'c3': [None, [{'x': 1}]]},
        ]
...
class aggtst_array_arr_agg_distinct_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            {"id": 0, "c1": [[12, 22], [23, 56, 16]], "c2": [None, [55, 66, None]], 'c3': [[{'a': 5, 'b': 66}], [{'c': 2}]]},
            {'id': 1, 'c1': [[23, 56, 16], [49]], 'c2': [[32, 34, 22, 12], [99]], 'c3': [None, [{'x': 1}]]}
        ]
...
class aggtst_array_arr_agg_where(TstView):
    def __init__(self):
        # checked manually
        self.data = [
            {"f_c1": [[23, 56, 16], [23, 56, 16]], "f_c2": [[55, 66, None], [99]], 'f_c3': [[{'c': 2}], None]}
        ]
...
class aggtst_array_arr_agg_where_gby(TstView):
    def __init__(self):
        # checked manually
        self.data = [
            {"id": 0, "f_c1": [[23, 56, 16]], "f_c2": [[55, 66, None]], 'f_c3': [[{'c': 2}]]},
