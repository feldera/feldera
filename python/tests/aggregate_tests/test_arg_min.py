...
class aggtst_int_arg_min_diff(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'c1': 5, 'c2': 3, 'c3': 6, 'c4': 2, 'c5': 2, 'c6': 3, 'c7': 4, 'c8': 3}]
...
class aggtst_int_arg_min_diff1(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'c1': 7, 'c2': -1, 'c3': 4, 'c4': 2, 'c5': 2, 'c6': 0, 'c7': 6, 'c8': -2}]
...
class aggtst_int_arg_min_gby_diff(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'id': 0, 'c1': 5, 'c2': 2, 'c3': 3, 'c4': 2, 'c5': 3, 'c6': 4, 'c7': 3, 'c8': 3},
                     {'id': 1, 'c1': 4, 'c2': 3, 'c3': 6, 'c4': 6, 'c5': 2, 'c6': 3, 'c7': 4, 'c8': 2}]
...
class aggtst_int_arg_min_where(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'f_c1': 5, 'f_c2': 2, 'f_c3': 3, 'f_c4': 2, 'f_c5': 2, 'f_c6': 1, 'f_c7': 3, 'f_c8': 3}]
...
class aggtst_int_arg_min_where_diff(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'f_c1': 5, 'f_c2': 2, 'f_c3': 6, 'f_c4': 2, 'f_c5': 2, 'f_c6': 1, 'f_c7': 3, 'f_c8': 3}]
...
class aggtst_int_arg_min_where_gby_diff1(TstView):
    def __init__(self):
        # checked manually
        self.data = [{'id': 0, 'f_c1': 7, 'f_c2': -3, 'f_c3': 1, 'f_c4': 2, 'f_c5': 30, 'f_c6': 1, 'f_c7': 6, 'f_c8': 0},
                     {'id': 1, 'f_c1': None, 'f_c2': None,'f_c3': 0, 'f_c4': 2, 'f_c5': 2, 'f_c6': 0, 'f_c7': None, 'f_c8': None}]
