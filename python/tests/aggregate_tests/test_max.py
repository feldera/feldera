...
class test_int_max_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_max_distinct(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'c1': 5, 'c2': 5, 'c3': 6, 'c4': 6, 'c5': 5, 'c6': 6, 'c7': 4, 'c8': 8}]
...
class test_int_max_distinct_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
        self.data = [{'id': 0, 'c1': 5, 'c2': 2, 'c3': 3, 'c4': 4, 'c5': 5, 'c6': 6, 'c7': 3, 'c8': 8},
                     {'id': 1, 'c1': 4, 'c2': 5, 'c3': 6, 'c4': 6, 'c5': 2, 'c6': 3, 'c7': 4, 'c8': 5}]
...
class test_int_max_where(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_max_Where_Groupby(TestView):
    def __init__(self):
        # Validated on Postgres
