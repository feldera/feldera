...
class aggtst_map_array_agg_value(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': [{'a': 75, 'b': 66}, {'f': 45, 'h': 66}, {'q': 11, 'v': 66}, {'q': 11, 'v': 66}, {'x': 8, 'y': 6}],
                'c2': [None, {'f': 1}, {'q': 11, 'v': 66, 'x': None}, {'q': 22}, {'i': 5, 'j': 66}]
            }
        ]
...
class aggtst_map_array_agg_gby(TstView):
    def __init__(self):
        # checked manually
        self.data = [
            {"id": 0, "c1": [{"a": 75, "b": 66}, {"q": 11, "v": 66}], "c2": [None, {"q": 22}]},
            {'id': 1, 'c1': [{'f': 45, 'h': 66}, {'q': 11, 'v': 66}, {'x': 8, 'y': 6}], 'c2': [{'f': 1}, {'q': 11, 'v': 66, 'x': None}, {'i': 5, 'j': 66}]}
        ]
...
class aggtst_map_array_agg_distinct(TstView):
    def __init__(self):
        ...
        self.data = [
            {
                'c1': [{'a': 75, 'b': 66}, {'f': 45, 'h': 66}, {'q': 11, 'v': 66}, {'x': 8, 'y': 6}],
                'c2': [None, {'f': 1}, {'i': 5, 'j': 66}, {'q': 11, 'v': 66, 'x': None}, {'q': 22}]
            }
        ]
...
class aggtst_map_array_agg_distinct_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            {"id": 0, "c1": [{"a": 75, "b": 66}, {"q": 11, "v": 66}], "c2": [None, {"q": 22}]},
            {'id': 1, 'c1': [{'f': 45, 'h': 66}, {'q': 11, 'v': 66}, {'x': 8, 'y': 6}], 'c2': [{'f': 1}, {'i': 5, 'j': 66}, {'q': 11, 'v': 66, 'x': None}]}
        ]
...
class aggtst_map_array_agg_where(TstView):
    def __init__(self):
        # checked manually
        self.data = [
            {'f_c1': [{'q': 11, 'v': 66}, {'q': 11, 'v': 66}], 'f_c2': [{'q': 11, 'v': 66, 'x': None}, {'q': 22}]}
        ]
...
class aggtst_map_array_agg_where_gby(TstView):
    def __init__(self):
        ...
        self.data = [
            ...
            {"id": 1, "f_c1": [{"q": 11, "v": 66}], "f_c2": [{"q": 11, "v": 66, "x": None}]},
        ]
