...
class test_int_count_col(TestView):
    def __init__(self):
...
class test_int_count_col_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_count_col_distinct(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_count_col_distinct_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_count_col_where(TestView):
    def __init__(self):
        # Validated on Postgres
...
class test_int_count_col_where_groupby(TestView):
    def __init__(self):
        # Validated on Postgres
