...
class aggtst_binary_array_agg_value(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {
                "c1": ["0c1620", "17382115", "17382115", "312b541d"],
                "c2": [None, "37424d58", "63141f4d", "2022160c"],
            }
        ]
...
class aggtst_binary_array_agg_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {"id": 0, "c1": ["0c1620", "17382115"], "c2": [None, "37424d58"]},
            {"id": 1, "c1": ["17382115", "312b541d"], "c2": ["63141f4d", "2022160c"]},
        ]
...
class aggtst_binary_array_agg_distinct(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {
                "c1": ["0c1620", "17382115", "312b541d"],
                "c2": [None, "2022160c", "37424d58", "63141f4d"],
            }
        ]
...
class aggtst_binary_array_agg_distinct_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
            {"id": 0, "c1": ["0c1620", "17382115"], "c2": [None, "37424d58"]},
            {"id": 1, "c1": ["17382115", "312b541d"], "c2": ["2022160c", "63141f4d"]},
        ]
...
class aggtst_binary_array_agg_where(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
...
class aggtst_binary_array_agg_where_gby(TstView):
    def __init__(self):
        # Validated on Postgres
        self.data = [
