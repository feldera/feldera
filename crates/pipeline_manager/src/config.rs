...
impl ManagerConfig {
    pub fn new(cli_args: &CliArgs) -> ManagerConfig {
        ManagerConfig {
            port: cli_args.port,
            bind_address: cli_args.bind_address.clone(),
            logfile: cli_args.logfile.clone(),
            working_directory: cli_args.working_directory.clone(),
            unix_daemon: cli_args.unix_daemon,
            use_auth: cli_args.use_auth,
            db_connection_string: cli_args.db_connection_string.clone(),
            initial_sql: cli_args.initial_sql.clone(),
...
impl CompilerConfig {
    pub fn new(cli_args: &CliArgs) -> CompilerConfig {
        CompilerConfig {
            ...
            precompile: cli_args.precompile,
        }
    }
