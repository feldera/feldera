...
"#;
    ...
    for upd in iter {
        let record = upd.unwrap_insert();
        assert!(record.field_1 >= SqlDecimal<28, 0>::new(0, 0));
        assert!(record.field_1 < SqlDecimal<27, 0>::new(20, 0));

        assert!(record.field_2 >= SqlDecimal<10, 10>::new(0, 0));
        assert!(record.field_2 < SqlDecimal<10, 10>::new(0.9999, 0));

        assert!(record.field_3 >= SqlDecimal<2, 1>::new(0, 1));
        assert!(record.field_3 < SqlDecimal<2, 1>::new(10, 0));
    }
...
"#;
    ...
    for upd in iter {
        let record = upd.unwrap_insert();
        assert!(record.field_1 >= SqlDecimal<28, 0>::new(1, 0));
        assert!(record.field_1 < SqlDecimal<28, 0>::new(5, 0));
        assert!(
            record.field_3 == SqlDecimal<2, 1>::new(1, 1)
                || record.field_3 == SqlDecimal<2, 1>::new(1, 0)
                || record.field_3 == SqlDecimal<2, 1>::new(99, 1)
        );
    }
}
    ...
    for upd in iter {
        ...
        assert!(
            record.field_1 == Decimal::new(1, 1)
                ...
                || record.field_1 == SqlDecimal<28, 0>::new(2, 0)
        );

        assert!(record.field_2 >= SqlDecimal<10, 10>::new(5, 1));
        assert!(record.field_2 < SqlDecimal<10, 10>::new(6, 1));

        assert!(record.field_3 >= SqlDecimal<2, 1>::new(-99, 1));
        assert!(record.field_3 < SqlDecimal<2, 1>::new(99, 1));
    }
}
...
"#;
    ...
    for upd in iter {
        let record = upd.unwrap_insert();
        assert!(
            record.field_1 == SqlDecimal<>new(1, 1)
                || record.field_1 == SqlDecimal<28, 0>::ONE
                || record.field_1 == SqlDecimal<28, 0>::new(2, 0)
        );

        assert!(record.field_2 >= SqlDecimal<10, 10>::new(0, 0));
        assert!(record.field_2 < SqlDecimal<10, 10>::new(1, 0));

        assert!(record.field_3 >= SqlDecimal<2, 1>::new(0, 0));
        assert!(record.field_3 < SqlDecimal<2, 1>::new(99, 1));
    }
}
