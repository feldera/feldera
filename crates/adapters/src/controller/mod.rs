...
impl FtState {
    ...
    fn new(ft: FtInit, controller: Arc<ControllerInner>) -> Result<Self, ControllerError> {
        ...
        let (step_metadata, step_rw) = Self::replay_step(step_rw, step, &controller)?;
    ...
    fn replay_step(
        ...
        step: Step,
        controller: &Arc<ControllerInner>,
    ) -> Result<(Option<StepMetadata>, StepRw), ControllerError> {
        // Read a step.
