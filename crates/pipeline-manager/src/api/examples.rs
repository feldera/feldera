...
use crate::api::pipeline::{
    PatchPipeline, PipelineFieldSelector, PipelineInfo, PipelineInfoInternal, PipelineSelectedInfo,
...
pub(crate) fn pipeline_1_selected_info() -> PipelineSelectedInfo {
    pipeline_selected_info_internal_to_external(PipelineSelectedInfoInternal::new(
        &extended_pipeline_1(),
