...
const MONITOR_STORE_EVENT_NUM_INTERVALS: u64 = 10;
...
const MONITOR_RETENTION_HOURS: u16 = 72; // 72 hours / 10 minutes = 432 events
const MONITOR_RETENTION_NUM: u16 = 1000;
...
pub async fn cluster_monitor<P: ResourcesPoller>(
    ...
    loop {
        ...
        ) = if common_config.enable_cluster_monitor_resources {
