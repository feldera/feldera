//! Test for https://github.com/feldera/feldera/issues/145
...
fn issue_145() {
    ...
    let mut circuit =
        DbspCircuit::new(graph, true, 1usize, CodegenConfig::debug(), Demands::new()).unwrap();
    ...
    let result = circuit.consolidate_output(NodeId::new(15759u32)).unwrap();
