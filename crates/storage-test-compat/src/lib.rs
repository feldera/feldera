...
//!
//! This crate defines deterministic rows for three tuple shapes:
//! - `GoldenRow` (Tup65) for the large, optimized format.
//! - `GoldenRowSmall` (Tup8) for the legacy/rkyv default layout.
//! - `GoldenRowVariant` (Tup26) covering all variant types.
//!
...
// There are 26 kinds of variant
pub type GoldenRowVariant = Tup26<
    Variant,
    Variant,
    Variant,
    Variant,
...
pub fn golden_row_variant(row: usize) -> GoldenRowVariant {
    ...
    let tz_v = Variant::TimestampTz(
        Timestamp::from_microseconds(1_600_000_000_000i64.wrapping_add(row as i64)).into(),
    );
...
mod tests {
    ...
    use super::{
        ...
        golden_row_small, golden_row_variant, golden_writer2_key, GoldenFileSpec, GoldenRow,
        GoldenRowSmall, GoldenRowVariant, GoldenSize, GoldenWriterKind,
    };
        ...
        for spec in golden_file_specs() {
            ...
            match (spec.writer, spec.size) {
                ...
                (GoldenWriterKind::Writer2Roaring, GoldenSize::Variant) => {
                    validate_writer2_rows::<GoldenRowVariant>(
                        &*storage_backend,
                        storage_path,
                        golden_row_variant,
                        golden_aux,
