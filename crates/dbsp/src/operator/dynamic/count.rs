    ...
    Z: IndexedZSet,
{
    ...
    pub fn dyn_weighted_count(
        ...
        self.dyn_weighted_count_generic(unique_name, factories, Box::new(|w, out| w.move_to(out)))
    }
    ...
    where
        Z: Send,
    {
        self.dyn_distinct_count_generic(unique_name, factories, Box::new(|w, out| w.move_to(out)))
    }
        ...
        Z: Send,
    {
        self.dyn_distinct(&factories.distinct_factories)
            .dyn_weighted_count_generic(unique_name, &factories.aggregate_factories, out_func)
    }
