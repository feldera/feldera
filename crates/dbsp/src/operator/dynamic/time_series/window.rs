    ...
    Box<B::Key>: Clone,
{
    ...
    fn eval(
        ...
        stream! {
            ...
            // XXX: This line generated 15GB of cache reads across 1,000 steps.
            ...
            // XXX: Uncommenting the next block generates another 10GB reads. Note that the body
            // of the loop below never executes, so all these reads are generated byt the two seek_...
            // calls below.
