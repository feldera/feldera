...
macro_rules! float {
    ($($outer:ident($inner:ident)),* $(,)?) => {
        $(
            ...
            #[derive(Default, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, SizeOf, rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, feldera_macros::IsNone, feldera_macros::OrdRepr)]
            #[repr(transparent)]
            #[size_of(skip_all)]
