...
fn empty_consumer() -> OrderedLayerConsumer<u64, u64, i64, u64> {
    OrderedLayerConsumer::from(
        OrderedBuilder::<u64, ColumnLayerBuilder<u64, i64>, u64>::new().done(),
    )
}
...
fn consumer_smoke_test() {
    ...
    let mut builder: OrderedBuilder<u64, ColumnLayerBuilder<u64, i64>, u64> =
...
#[test]
fn remaining_values() {
    let mut builder = OrderedBuilder::<u64, ColumnLayerBuilder<u64, i64>, u64>::new();
    for idx in 0..10 {
