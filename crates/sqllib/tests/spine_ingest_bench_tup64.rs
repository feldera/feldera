...
const U64_INPUT_SIZE: usize = 64 * std::mem::size_of::<u64>();
        ...
        for &input_size in &input_sizes {
            for &batch_size in &batch_sizes {
                ...
                let line = match input_type {
                    ...
                    InputType::U64 => run_one_case::<U64Tuple>(
                        threads,
                        input_size,
                        duration_secs,
                        batch_size,
