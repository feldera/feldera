...
fn short_interval() -> BoxedStrategy<ShortInterval> {
    i64_val().prop_map(ShortInterval::from_milliseconds).boxed()
}
...
fn edge_values_tup6() -> Vec<Tup6Ty> {
    vec![
        ...
        Tup6::new(
            Some(max_byte_array()),
            Some(max_geo_point()),
            Some(ShortInterval::from_milliseconds(i64::MAX)),
