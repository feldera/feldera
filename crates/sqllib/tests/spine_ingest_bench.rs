...
use dbsp::trace::{Batch, BatchReaderFactories, Batcher, MergerType, Spine, Trace};
...
const PRODUCERS_PER_CONSUMER: usize = 1;
const MAX_BUFFERED_RECORDS: usize = 1_500_000_000;
