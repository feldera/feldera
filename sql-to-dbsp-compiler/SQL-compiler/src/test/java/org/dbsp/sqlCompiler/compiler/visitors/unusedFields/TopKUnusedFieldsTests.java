...
public class TopKUnusedFieldsTests extends SqlIoTest {
    ...
    public void testSoftDeletes() {
        ...
        // The window passes k, deleted, name, qty, kind; the four columns nobody
        // reads (note, owner, price, created) are gone before it, and ts is dropped
        // from the value because it is the window's key.
