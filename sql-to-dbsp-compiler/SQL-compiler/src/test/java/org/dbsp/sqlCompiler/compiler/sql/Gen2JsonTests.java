 ...
 * {@code TypedBox<T, _>} type as {@code T}, and an aggregate operator keeps its per-aggregate
 * list instead of one fold over a tuple accumulator.  The {@code --jit} JSON keeps the Rust
 * forms. */
