...
/** A type corresponding to the SQL type TIMESTAMP WITH TIME ZONE.
 * Precision is fixed at 6 (microseconds). */
public class DBSPTypeTimestampTz extends DBSPTypeBaseType
    ...
    public DBSPExpression defaultValue() {
        ...
        return new DBSPTimestampTzLiteral(CalciteObject.EMPTY, this,
                new TimestampWithTimeZoneString("1970-01-01 00:00:00 UTC"));
    }

    @Override
    public DBSPExpression getMaxValue() {
        return new DBSPTimestampTzLiteral(CalciteObject.EMPTY, this,
                new TimestampWithTimeZoneString("9999-12-31 23:59:59.999999 UTC"));
    }

    @Override
    public DBSPExpression getMinValue() {
        return new DBSPTimestampTzLiteral(CalciteObject.EMPTY, this,
                new TimestampWithTimeZoneString("0001-01-01 00:00:00 UTC"));
    }
