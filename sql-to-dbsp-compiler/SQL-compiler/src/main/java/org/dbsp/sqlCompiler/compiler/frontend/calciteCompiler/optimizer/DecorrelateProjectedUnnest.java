 ...
 *         LeftSubquery
 */
public class DecorrelateProjectedUnnest
        extends RelRule<DefaultOptRuleConfig<DecorrelateProjectedUnnest>>
        implements TransformationRule {

    protected DecorrelateProjectedUnnest() {
        super(DecorrelateProjectedUnnest.CONFIG);
    }
    ...
    @Override public void onMatch(RelOptRuleCall call) {
        ...
        Project outerProject = call.rel(3);
        Uncollect uncollect = call.rel(4);
        Project project = call.rel(5);
        ...
        if (projected instanceof RexFieldAccess fa) {
            ...
            if (referenceExpr instanceof RexCorrelVariable cv) {
                ...
                builder.project(outerProject.getProjects());
    ...
    private static final DefaultOptRuleConfig<DecorrelateProjectedUnnest> CONFIG =
            DefaultOptRuleConfig.<DecorrelateProjectedUnnest>create()
