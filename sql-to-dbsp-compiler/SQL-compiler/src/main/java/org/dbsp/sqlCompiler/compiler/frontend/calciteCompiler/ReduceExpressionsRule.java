...
/**
 * Clone of Calcite {@link org.apache.calcite.rel.rules.ReduceExpressionsRule}
 * which does not fold ROW expressions.
 *
 * <P>Collection of planner rules that apply various simplifying transformations on
...
public abstract class ReduceExpressionsRule<C extends org.apache.calcite.rel.rules.ReduceExpressionsRule.Config>
        extends RelRule<C>
    ...
    public static class ProjectReduceExpressionsRule
        ...
        protected ProjectReduceExpressionsRule(ProjectReduceExpressionsRule.ProjectReduceExpressionsRuleConfig config) {
            super(config);
        }
        ...
        @Override public void onMatch(RelOptRuleCall call) {
            ...
            if (ReduceExpressionsRule.reduceExpressions(project, expList, predicates, false,
                    config.matchNullability(), config.treatDynamicCallsAsConstant())) {
    ...
    public static class JoinReduceExpressionsRule
            extends org.apache.calcite.rel.rules.ReduceExpressionsRule<org.apache.calcite.rel.rules.ReduceExpressionsRule.JoinReduceExpressionsRule.JoinReduceExpressionsRuleConfig> {
        /** Creates a JoinReduceExpressionsRule. */
        protected JoinReduceExpressionsRule(JoinReduceExpressionsRule.JoinReduceExpressionsRuleConfig config) {
            super(config);
        }
    ...
    public static class CalcReduceExpressionsRule
            extends org.apache.calcite.rel.rules.ReduceExpressionsRule<org.apache.calcite.rel.rules.ReduceExpressionsRule.CalcReduceExpressionsRule.CalcReduceExpressionsRuleConfig> {
        /**
         * Creates a CalcReduceExpressionsRule.
         */
        protected CalcReduceExpressionsRule(CalcReduceExpressionsRule.CalcReduceExpressionsRuleConfig config) {
            super(config);
        }
    ...
    public static class WindowReduceExpressionsRule
            extends org.apache.calcite.rel.rules.ReduceExpressionsRule<org.apache.calcite.rel.rules.ReduceExpressionsRule.WindowReduceExpressionsRule.WindowReduceExpressionsRuleConfig> {
        /** Creates a WindowReduceExpressionsRule. */
        protected WindowReduceExpressionsRule(WindowReduceExpressionsRule.WindowReduceExpressionsRuleConfig config) {
            super(config);
        }
    ...
    protected static class ReducibleExprLocator extends RexVisitorImpl<Void> {
        ...
        void processWindowBound(RexWindowBound bound) {
            ...
            bound.accept(this);
            ReducibleExprLocator.Constancy constancy = Util.last(stack);
        ...
        private void analyzeCall(RexCall call, ReducibleExprLocator.Constancy callConstancy) {
            ...
            // This part was removed in Calcite, but we want to prevent optimizing
            // IS_NULL(ROW(NULL)) to NULL, so we avoid classifying ROW as a constant ever.
