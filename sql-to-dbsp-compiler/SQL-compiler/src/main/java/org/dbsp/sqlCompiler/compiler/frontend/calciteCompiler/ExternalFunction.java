...
public class ExternalFunction extends SqlFunction {
    ...
    public DBSPType getFunctionReturnType(TypeCompiler compiler) {
        return compiler.convertType(this.returnType, true);
    }
    ...
    public DBSPFunction getImplementation(TypeCompiler compiler, IErrorReporter reporter) {
        ...
        if (this.getName().toLowerCase().startsWith("jsonstring_as_")) {
            ...
            DBSPType structType = compiler.convertType(this.returnType, true);
            ...
            DBSPLetStatement json = new DBSPLetStatement("json",
                    new DBSPApplyExpression("parse_json", DBSPTypeAny.getDefault(), param.asVariable()));
            statements.add(json);
            DBSPExpression toStruct = new DBSPApplyExpression("json_as", structType.setMayBeNull(true), json.getVarReference());
