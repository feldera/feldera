...
public abstract class InnerRewriteVisitor
    ...
    @Override
    public boolean preorder(DBSPTypeBaseType type) {
        this.map(type, type);
        return false;
    }
    ...
    @Override
    public boolean preorder(DBSPTypeIndexedZSet type) {
    ...
    @Override
    public boolean preorder(DBSPTypeVec type) {
    ...
    @Override
    public boolean preorder(DBSPTypeZSet type) {
        DBSPType elementType = this.transform(type.elementType);
        DBSPType weightType = this.transform(type.weightType);
        DBSPType result = type;
    ...
    @Override
    public boolean preorder(DBSPDateLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (type != expression.getNonVoidType())
    ...
    @Override
    public boolean preorder(DBSPDecimalLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (type != expression.getNonVoidType())
    ...
    @Override
    public boolean preorder(DBSPGeoPointLiteral expression) {
    ...
    @Override
    public boolean preorder(DBSPI16Literal expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (type != expression.getNonVoidType())
    ...
    @Override
    public boolean preorder(DBSPIntervalMillisLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (type != expression.getNonVoidType())
    ...
    @Override
    public boolean preorder(DBSPIntervalMonthsLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (type != expression.getNonVoidType())
    ...
    @Override
    public boolean preorder(DBSPISizeLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (type != expression.getNonVoidType())
    ...
    @Override
    public boolean preorder(DBSPKeywordLiteral expression) {
        this.map(expression, expression);
        return false;
    }

    @Override
    public boolean preorder(DBSPNullLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
    ...
    @Override
    public boolean preorder(DBSPStrLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (!type.sameType(expression.getNonVoidType()))
    ...
    @Override
    public boolean preorder(DBSPTimeLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (!type.sameType(expression.getNonVoidType()))
    ...
    @Override
    public boolean preorder(DBSPTimestampLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (!type.sameType(expression.getNonVoidType()))
    ...
    @Override
    public boolean preorder(DBSPU32Literal expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (!type.sameType(expression.getNonVoidType()))
    ...
    @Override
    public boolean preorder(DBSPU64Literal expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (!type.sameType(expression.getNonVoidType()))
    ...
    @Override
    public boolean preorder(DBSPUSizeLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
        DBSPExpression result = expression;
        if (!type.sameType(expression.getNonVoidType()))
    ...
    @Override
    public boolean preorder(DBSPVecLiteral expression) {
        DBSPType type = this.transform(expression.getNonVoidType());
    ...
    @Override
    public boolean preorder(DBSPNoComparatorExpression expression) {
