...
public abstract class BaseRustCodeGenerator implements ICodeGenerator {
    ...
    public static final String ALLOC_PREAMBLE = """
            ...
            pub static malloc_conf: &[u8] = b"prof:true,prof_active:true,lg_prof_sample:19,background_thread:true,metadata_thp:auto,dirty_decay_ms:30000,muzzy_decay_ms:30000\\0";""";
