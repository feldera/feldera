...
/** Reports an error for each equality comparison applied to ROW values.
 *
 ...
 */
public class RejectRowEquality extends RelHomogeneousShuttle {
    ...
    public RejectRowEquality(IErrorReporter reporter) {
    ...
    class CheckExpression extends RexShuttle {
        ...
        public RexNode visitSubQuery(RexSubQuery subQuery) {
            subQuery.rel.accept(RejectRowEquality.this);
