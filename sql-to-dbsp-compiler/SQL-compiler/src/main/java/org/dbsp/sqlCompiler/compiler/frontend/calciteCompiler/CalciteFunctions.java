...
public class CalciteFunctions implements FunctionDocumentation.FunctionRegistry {
    ...
    final Func[] toLoad = {
            ...
            new Func(SqlStdOperatorTable.TRUNCATE, "TRUNCATE", SqlLibrary.STANDARD, "decimal#truncate,decimal#truncate2,float#truncate,float#truncate2", false),
            ...
            new Func(SqlStdOperatorTable.FLOOR, "FLOOR", SqlLibrary.STANDARD,
                    "decimal#floor,float#floor,datetime#date_floor,datetime#timestamp_floor,datetime#time_floor", false),
            new Func(SqlStdOperatorTable.CEIL, "CEIL", SqlLibrary.STANDARD,
                    "decimal#ceil,float#ceil,datetime#date_ceil,datetime#timestamp_ceil,datetime#time_ceil", false),
            ...
            new Func(SqlLibraryOperators.TRUNC_BIG_QUERY, "TRUNC", SqlLibrary.BIG_QUERY,
                    "decimal#trunc,float#trunc", false),
