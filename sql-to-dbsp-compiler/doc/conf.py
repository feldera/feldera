...
project = u'A compiler from SQL to DBSP'
copyright = u'2023'
author = u'DBSP Project'
...
latex_documents = [
    (master_doc, 'sqltodbsp.tex', u'A Compiler from SQL to DBSP',
     u'DBSP Project', 'manual', True),
]
...
man_pages = [
    (master_doc, 'SQLtoDBSP', u'SQLtoDBSP', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'A compiler from SQL to DBSP', u'A compiler from SQL to DBSP',
     author, 'DBSP Project', '', 'Miscellaneous'),
]


# -- Options for Epub output -------------------------------------------------
epub_title = project
epub_description = 'A compiler from SQL to DBSP'
