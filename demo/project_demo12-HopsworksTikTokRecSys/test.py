...
from feldera.formats import JSONFormat
...
process_input(sql, [
    {
        ...
        "watch_time": 10,
        "interaction_date": datetime.strptime("2024-07-11 01:00:00", "%Y-%m-%d %H:%M:%S"),
        "previous_interaction_date": datetime.strptime("2024-07-11 00:00:00", "%Y-%m-%d %H:%M:%S"),
...
process_input(sql, [
    {
        ...
        "interaction_type": "like",
        "watch_time": 10,
        "interaction_date": datetime.strptime("2024-07-11 01:00:10", "%Y-%m-%d %H:%M:%S"),
        "previous_interaction_date": datetime.strptime("2024-07-11 00:00:00", "%Y-%m-%d %H:%M:%S"),
        "interaction_month": datetime.strptime("2024-07-01", "%Y-%m-%d"),
    },
    {
        ...
        "interaction_type": "like",
        "watch_time": 20,
        "interaction_date": datetime.strptime("2024-07-11 01:00:20", "%Y-%m-%d %H:%M:%S"),
        "previous_interaction_date": datetime.strptime("2024-07-11 00:00:00", "%Y-%m-%d %H:%M:%S"),
        "interaction_month": datetime.strptime("2024-07-01", "%Y-%m-%d"),
    }
])
...
process_input(sql, [
    {
        ...
        "interaction_type": "like",
        "watch_time": 70,
        "interaction_date": datetime.strptime("2024-07-11 03:00:10", "%Y-%m-%d %H:%M:%S"),
        "previous_interaction_date": datetime.strptime("2024-07-11 00:00:00", "%Y-%m-%d %H:%M:%S"),
        "interaction_month": datetime.strptime("2024-07-01", "%Y-%m-%d"),
    },
    {
        ...
        "interaction_type": "like",
        "watch_time": 70,
        "interaction_date": datetime.strptime("2024-07-11 03:00:20", "%Y-%m-%d %H:%M:%S"),
        "previous_interaction_date": datetime.strptime("2024-07-11 00:00:00", "%Y-%m-%d %H:%M:%S"),
        "interaction_month": datetime.strptime("2024-07-01", "%Y-%m-%d"),
    }
])
