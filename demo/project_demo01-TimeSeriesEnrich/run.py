...
def make_config(project):
    ...
    config.add_kafka_output(
        name="Join Demographics⋈Transactions",
        stream="TRANSACTIONS_WITH_DEMOGRAPHICS",
        config=KafkaOutputConfig.from_dict({"topic": "fraud_demo_large_enriched"}),
