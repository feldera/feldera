...
Here we configure OTel Collector to send this data to Feldera as JSON via an HTTP POST request without any compression.
...
Notice that we have the query parameters: `format=json&update_format=raw`
