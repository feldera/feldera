...
`output_connector_` part is what puts them in the generated metrics reference without a
template change, as the Delta input connector's `input_connector_delta_*` already does.
