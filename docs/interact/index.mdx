...
<div className="card">
  <div className="card__body">
    ...
    <p>All the above methods interact with Feldera using the REST API. This is intended for users who would like to build their own clients to Feldera. `Pipeline` is the most important API type. </p>
  </div>
</div>
```
