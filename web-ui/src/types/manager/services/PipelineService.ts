...
export class PipelineService {
    ...
    public static newPipeline(
        requestBody: NewPipelineRequest,
    ): CancelablePromise<NewPipelineResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/pipelines',
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static pipelineShutdown(
        requestBody: ShutdownPipelineRequest,
     ...
     * @throws ApiError
     */
    public static pipelineMetadata(
        pipelineId: number,
