...
export class ConfigService {
   ...
   * @throws ApiError
   */
  public static newConfig(requestBody: NewConfigRequest): CancelablePromise<NewConfigResponse> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/configs',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static updateConfig(requestBody: UpdateConfigRequest): CancelablePromise<UpdateConfigResponse> {
    return __request(OpenAPI, {
      method: 'PATCH',
      url: '/configs',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static configStatus(configId: number): CancelablePromise<ConfigDescr> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static deleteConfig(configId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/configs/{config_id}',
      path: {
