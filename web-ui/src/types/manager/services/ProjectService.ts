...
export class ProjectService {
    ...
    public static newProject(
        requestBody: NewProjectRequest,
    ): CancelablePromise<NewProjectResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/projects',
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static compileProject(
        requestBody: CompileProjectRequest,
     ...
     * @throws ApiError
     */
    public static cancelProject(
        requestBody: CancelProjectRequest,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/projects/compile',
    ...
    public static projectStatus(
        projectId: number,
    ): CancelablePromise<ProjectDescr> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static projectCode(
        projectId: number,
    ): CancelablePromise<ProjectCodeResponse> {
        return __request(OpenAPI, {
            method: 'GET',
