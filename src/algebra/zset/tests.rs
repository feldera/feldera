...
fn checked_zset_integer_weights_tests() {
    ...
    z.increment(&0, CheckedI64::new(1));
    assert_eq!(1, z.support_size());
    ...
    z.increment(&1, CheckedI64::new(-1));
    assert_eq!(2, z.support_size());
    assert_eq!(
        finite_map! {
            0 => CheckedI64::new(1),
...
fn zset_tuple_tests() {
    ...
    z.increment(&(0, 0), CheckedI64::new(1));
    assert_eq!(1, z.support_size());
...
pub fn indexed_zset_tests() {
    ...
    set.increment(&(2, 0), CheckedI64::new(2));
    set.increment(&(1, 0), CheckedI64::new(-1));
    set.increment(&(-1, 0), CheckedI64::new(1));

    let partitioned = set.clone().partition(|(left, _)| left.abs() % 2);
    assert_eq!(
        finite_map! {
            0 => finite_map! {
                (0, 0) => CheckedI64::new(1),
