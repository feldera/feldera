...
#
#   make -f suite.mk runners='dbsp flink' modes=batch events=1M

# Fill these in, or pass on the command line, to enable dataflow tests.
project =
bucket =

runners = dbsp flink beam.flink beam.spark beam.dataflow
modes = batch stream
